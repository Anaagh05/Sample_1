...
const GlobeIcon = ({ className = "w-10 h-10 mb-4" }) => (
  ...
  >
    <path
      d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zM2 12h20M12 2v20"
      stroke="currentColor"
      strokeWidth="1.6"
      strokeLinecap="round"
...
const PaletteIcon = ({ className = "w-10 h-10 mb-4" }) => (
  ...
  >
    <path
      d="M12 3C7 3 3 7 3 12s4 6 9 6c1.5 0 2.75-1.5 2.75-3.25 0-1.25-1-1.75-1.75-2 0 0-1.75-.5-1.75-2 0-1.25 1.75-2.75 3.5-2.75S18 7 18 5.5C18 4 15 3 12 3z"
      stroke="currentColor"
      strokeWidth="1.2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const StarIcon = ({ className = "w-10 h-10 mb-4" }) => (
  ...
  >
    <path
      d="M12 17.3L6.16 20l1.16-6.77L2 9.24l6.9-1L12 2l3.1 6.24L22 9.24l-5.32 4.0L17.84 20z"
      stroke="currentColor"
      strokeWidth="1.2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const PhoneIcon = ({ className = "w-5 h-5" }) => (
  ...
  >
    <path
      d="M22 16.92V21a1 1 0 0 1-1.09 1A19 19 0 0 1 3 4.09 1 1 0 0 1 4 3h4.09a1 1 0 0 1 1 .75c.12.62.34 1.2.66 1.72a1 1 0 0 1-.17 1.11L8.91 8.91a16 16 0 0 0 6.18 6.18l1.33-1.33a1 1 0 0 1 1.11-.17c.52.32 1.1.54 1.72.66a1 1 0 0 1 .75 1V22z"
      stroke="currentColor"
      strokeWidth="1.2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const MailIcon = ({ className = "w-5 h-5" }) => (
  ...
  >
    <path
      d="M3 8l9 6 9-6M21 19H3a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h18a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2z"
      stroke="currentColor"
      strokeWidth="1.2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
function Button({ children, href, onClick, className = "", ...props }) {
  const base =
    "inline-block rounded-2xl px-6 py-3 text-lg font-medium shadow-md";
  if (href) {
    return (
...
export default function AnaaghPortfolio() {
  const services = [
    ...
    },
    {
      ...
      Icon: PaletteIcon,
      description:
        "Creative and professional designs that make your brand stand out.",
    },
    {
      title: "Video Making",
      Icon: VideoIcon,
      description:
        "Engaging videos to showcase your products, services, or story.",
    },
    {
      title: "Free Basic Numerological Insight",
      Icon: StarIcon,
      description:
        "A unique touch – receive a basic numerological analysis with your project.",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-8 flex flex-col justify-between">
      <main className="max-w-4xl mx-auto text-center">
        <div className="flex justify-center mb-6">
          <div className="w-24 h-24 rounded-full overflow-hidden bg-white shadow-md flex items-center justify-center">
            <img src="/AnaaghLogo.jpg" alt="Anaagh Logo" />
          </div>
        </div>
      ...
      <footer className="mt-12 text-center text-gray-700">
        <div className="flex flex-col items-center space-y-2">
          ...
          <a
            href="mailto:anaagh05@gmail.com"
